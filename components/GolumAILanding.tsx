        ...
        <section className="relative mx-auto max-w-6xl px-6 pb-16 pt-14 sm:pt-20">
          <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              ...
              >
                Golem is an intelligent natural language layer for your business' AI-Ops. It is an AI that can be interacted with by anybody regardless of their background. Our servers configured in custom context protocols connect to your systems to help sand-box/execute safe, evidence-grounded realities.
              </motion.p>
